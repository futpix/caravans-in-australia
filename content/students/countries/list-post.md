...
draft: false
author: Sean
cardText: Convey message as items post
contentIcon: "/images/icon-type.png"
definePost: "The List content type is a post that usually claims to have 'x' amount of points to make in regards to a topic. Each point is then denoted by a number, and the sum referred to in the Title."
structureImage: "/images/structure-list.png"
